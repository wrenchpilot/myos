...
PS1="\n\[$(retval=$?;tput cup 9999 0;exit $retval)\]\${icon_start}$(virtualenv_prompt)${icon_user}${bold_green}\u${normal}${icon_host}${red}\h${normal}${icon_directory}${bold_purple}\W${normal}\$([[ -n \$(git branch 2> /dev/null) ]] && echo \" on ${icon_branch} \")${white}$(scm_prompt_info)${normal}\n${icon_end}[${blue}\@${normal}][${red}\w${normal}]$ "
PS2="${icon_end} "
}
